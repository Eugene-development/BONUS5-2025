	...
	<div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
		...
		<div class=" max-w-7xl px-6 py-8">
			<p class="text-sm text-gray-500">
				<sup>*</sup> только с согласия клиента
			</p>
		</div>
	</div>
</div>
	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl lg:mx-0">
			...
			<p class="mt-6 text-lg/8 text-gray-600">
				Наш сервис предназначен для компаний, которые хотят повысить мотивацию сотрудников и
				увеличить продажи. Мы предлагаем удобную систему бонусов и поощрений для разных категорий
				специалистов.
			</p>
		</div>
		<div
