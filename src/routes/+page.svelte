			...
			<div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
				...
				<dl class="mt-10 space-y-4 text-base/7 text-gray-300">
					<div class="flex gap-x-4">
						...
						<dd>Надёжно. Мы работаем с лучшими мебельными компаниями.</dd>
					</div>
					<div class="flex gap-x-4">
						<dt class="flex-none">
							<span class="sr-only">Address</span>
						...
						<dd>Конфиденциально. Мы не будем раскрывать ваши данные.</dd>
					</div>
					<div class="flex gap-x-4">
						<dt class="flex-none">
							<span class="sr-only">Address</span>
						...
						<dd>Честно. Гарантировано выплатим бонус в полном объёме.</dd>
					</div>
					...
					<div class="flex gap-x-4">
						...
						<dd>Выгодно. Хороший дополнительный заработок для вас.</dd>
					</div>
				</dl>
			</div>
		</div>
