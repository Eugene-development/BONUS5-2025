  ...
  <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
    <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
      <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
        ...
        <h2 class="text-pretty text-4xl font-semibold tracking-widest text-white sm:text-6xl">BONUS5</h2>
        <p class="mt-6 text-lg/8 text-gray-300">Отправьте нам контакты потенциального клиента и получите бонус 5%, если сделка состоится.</p>
        <dl class="mt-10 space-y-4 text-base/7 text-gray-300">
          <div class="flex gap-x-4">
            ...
            <dd>Конфиденциально. Мы не раскрываем ваши данные.</dd>
          </div>
          <div class="flex gap-x-4">
            <dt class="flex-none">
              <span class="sr-only">Address</span>
            ...
            <dd>Честно. Выплаты гарантируем в полном объёме.</dd>
          </div>
          <div class="flex gap-x-4">
            <dt class="flex-none">
              <span class="sr-only">Address</span>
            ...
            <dd>Выгодно. Хороший дополнительный заработок.</dd>
          </div>
    ...
    <form action="#" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
      <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            <label for="first-name" class="block text-sm/6 font-semibold text-white">Имя клиента</label>
            <div class="mt-2.5">
          ...
          <div>
            <label for="last-name" class="block text-sm/6 font-semibold text-white">Ваш пин код</label>
            <div class="mt-2.5">
          ...
          <div class="sm:col-span-2">
            <label for="phone-number" class="block text-sm/6 font-semibold text-white">Телефон (мессенджер)</label>
            <div class="mt-2.5">
          ...
          <div class="sm:col-span-2">
            <label for="message" class="block text-sm/6 font-semibold text-white">Комментарий</label>
            <div class="mt-2.5">
        ...
        <div class="mt-8 flex justify-end">
          <button type="submit" class="rounded-md bg-indigo-400 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-pink-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Отправить в работу</button>
        </div>
      </div>
    </form>
  </div>
...
<div class="bg-white py-24 sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Для кого сервис</h2>
